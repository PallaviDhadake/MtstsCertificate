...
using System.Data;
public partial class adminpanel_certificate_stud_list : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    private void FillGrid()
    {
        try
        {
            using (DataTable dtcertificate = c.GetDataTable("Select CertID, CertNumber, CertCourseName, CertDuration, CertStudentName, CertPlace, CertGrade From CertificateData"))
